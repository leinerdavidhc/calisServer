...
import { User, GetUserAttributes, addUserAttributes } from "../models/user.model";
...
export default class UserController {
  public static async createUser(req: Request, res: Response): Promise<any> {
    ...
    try {
      ...
      const existingUser: GetUserAttributes[] | null = await User.findAll({
  ...
  public static async PreCreateUser(req: Request, res: Response): Promise<any> {
  ...
  public static async getProtectedData(req: Request, res: Response): Promise<any> {
    const user = req.user;
    res
      .status(200)
  ...
  public static async getOneUser(req: Request, res: Response): Promise<any> {
    ...
    public static async generateCode(req: Request, res: Response): Promise<any> {
